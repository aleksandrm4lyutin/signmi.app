...
import 'package:signmi_app/functions/share_link_generator.dart';

import '../models/route_arguments.dart';
import '../pages/editor_loader.dart';
import '../pages/help_page.dart';
import '../pages/home_page_profile_loader.dart';
import '../pages/public_viewer.dart';
import '../pages/public_viewer_loader.dart';
import '../pages/scan_module.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    //TODO====================
      ...
      case '/help_page':
        ...
        break;
      default: return MaterialPageRoute(builder: (_) => const Wrapper());
    }
  }
}